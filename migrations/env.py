...
coco_config = get_config(os.getenv('CONFIG', 'dev'))
config.set_main_option('sqlalchemy.url', coco_config.SQLALCHEMY_DATABASE_URI)

# hack to load models so they're picked up by alembic
